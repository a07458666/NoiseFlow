...
parser.add_argument('--pseudo_std', default=0.0, type=float)
...
parser.add_argument('--center_momentum', default=0.80, type=float, help='use centering')
...
for epoch in range(0, args.num_epochs+1):
    ...
    save_point_1 = os.path.join(model_save_loc, f"model_name_1_{epoch}.pth.tar")
    save_point_flow_1 = os.path.join(model_save_loc, f"model_name_flow_1_{epoch}.pth.tar")
    save_point_2 = os.path.join(model_save_loc, f"model_name_2_{epoch}.pth.tar")
    save_point_flow_2 = os.path.join(model_save_loc, f"model_name_flow_2_{epoch}.pth.tar")

    torch.save(net1.module.state_dict(), save_point_1)
    torch.save(flowNet1.module.state_dict(), save_point_flow_1)
    torch.save(net2.module.state_dict(), save_point_2)
    torch.save(flowNet2.module.state_dict(), save_point_flow_2)
